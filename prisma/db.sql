...
CREATE INDEX "embeddings_embedding_idx" ON "embeddings"("embedding");
...
ALTER TABLE "projects" ADD CONSTRAINT "projects_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "users"("email") ON DELETE NO ACTION ON UPDATE NO ACTION;
